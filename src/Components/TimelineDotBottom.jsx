  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div >
          <div className="date" style={dots.date}>{ this.props.label }-- {this.props.distanceFromOrigin - this.props.labelWidth / 2}</div>
          <div className="timezone-time" style={dots.timezonetime}>12:00 CET</div>
          <div key='dot-dot-div' className={`infoDescription`} style={dots.infoDescription}>Sign</div>
        </div>
