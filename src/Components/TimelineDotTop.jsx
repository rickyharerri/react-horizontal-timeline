...
class TimelineDot extends React.Component {
  ...
  __getDotStylesForBar__ = (dotType, key, to) => {
    const hoverStyle = {
      backgroundColor: `yellow`,
      border: `2px solid yellow`,
      width: this.props.labelWidth * this.props.todiff,
      marginLeft: this.props.labelWidth / 2 + dots.base.width / 2,
    };
    return hoverStyle;
  }
  ...
  render() {
    ...
    return (
      ...
      >
        <div style={this.__getDotStylesForBar__(dotType, this.props.date, this.props.to)}>{ this.props.label }--{this.props.todiff}</div>
        {/* <span
          key='dot-dot'
